...
class AllJobs extends Component {
  ...
  onGetProfileDetails = async () => {
    ...
    const profileApiUrl = 'https://api.ccbp.in/profile'
  ...
  render() {
    const {searchInput, apiJobsStatus} = this.state
      ...
      <>
        ...
        <div className="all-jobs-container">
          <div className="side-bar-container">
            ...
            <hr className="hr-line" />
            <h1 className="text">Salary Range</h1> {/* Corrected heading */}
          ...
          <div className="jobs-container">
            <div>
              <input
                ...
                id="searchInput"
              />
              <label htmlFor="searchButton" className="search-button-label">
                Search
              </label>
              <button
